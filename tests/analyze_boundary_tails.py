# -*- coding: utf-8 -*-
"""
analyze_boundary_tails.py: 边界变量长尾效应诊断分析

================================================================================
功能描述：
    本脚本分析高层边界（Upper-layer boundaries）的分布特征及其长尾效应，
    用于诊断 Tilt 指数极大值的成因。

主要输出：
    1. 上层 vs 下层西边界对比直方图
    2. 上层西边界位置 vs Tilt 值散点图
    3. 箱线图可视化异常值分布
    4. 描述性统计（1%/5%/50%/95%/99%分位数）

核心问题：
    为什么 Tilt 指数有时会出现极大值？是否与上层边界的异常偏移相关？
"""
