# -*- coding: utf-8 -*-
"""
plot_oni_vs_tilt_phase_speed.py
ONI 与 tilt_q / phase_speed 的连续回归散点图
"""
import pandas as pd
import numpy as np
...
OUT = r"E:\Projects\ENSO_MJO_Tilt\outputs\figures\enso_tilt_q\oni_vs_tilt_phase_speed.png"
...
def main():
    ...
    for ax, y, ylabel, title in [
        (axes[0], tilt, "Tilt_q (deg)", "ONI vs Tilt_q"),
